...
import grammar from "./larva.ohm-bundle";

const semantics = grammar.createSemantics();
const larvaDrawing = {
  check,
  evaluate,
} satisfies LarvaLanguage;

function evaluate(expr: string): LarvaCommand[] {
...
semantics.addOperation<LarvaCommand>("command()", {
  drawToCommand(x) {
    return x.command();
  },
...
semantics.addOperation<LarvaCommand[]>("run()", {
